...
namespace ASC.Core.Common.Tests
{
    ...
    public class DbUserServiceTest : DbBaseTest<DbUserService>
    {
        ...
        public void CRUDGroup()
        {
            ...
            CollectionAssert.AreEquivalent(Service.GetGroups(Tenant, now).Values, new[] { g1, g2 });

            Service.RemoveGroup(Tenant, g1.Id, true);
            CollectionAssert.IsEmpty(Service.GetGroups(Tenant, new DateTime(1900, 1, 1)));
        }
        ...
        public void CRUDUserGroupRef()
        {
            ...
            CollectionAssert.IsEmpty(Service.GetUserGroupRefs(Tenant, new DateTime(1900, 1, 1)));
            ...
            CollectionAssert.AreEquivalent(new[] { gu1, gu2 }, Service.GetUserGroupRefs(Tenant, new DateTime(1900, 1, 1)).Values);
