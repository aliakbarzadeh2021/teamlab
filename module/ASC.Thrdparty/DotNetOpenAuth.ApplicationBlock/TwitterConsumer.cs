...
namespace DotNetOpenAuth.ApplicationBlock
{
    ...
    public static class TwitterConsumer
    {
        ...
        {
            return GetUserInfo(TwitterSignIn, userid, accessToken);
        }
        ...
        {
            return StartSignInWithTwitter(TwitterSignIn, forceNewLogin);
        }
        ...
        {
            return TryFinishSignInWithTwitter(TwitterSignIn, out screenName, out userId, out accessToken);
        }
        ...
        /// otherwise <c>false</c> to indicate that no Twitter response was present.
        /// </returns>
        public static bool TryFinishSignInWithTwitter(WebConsumer consumer, out string screenName, out int userId, out string accessToken)
        {
            screenName = null;
            userId = 0;
