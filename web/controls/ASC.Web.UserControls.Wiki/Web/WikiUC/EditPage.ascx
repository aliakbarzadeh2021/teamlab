...
<script language="javascript" type="text/javascript">
    ...
    function WikiConfigAdditionalInfo(config) {
        config.Plugins.Add(WikiPlugName, 'en,ru');
    ...
    <div class="wikiEdit">
        <asp:PlaceHolder ID="phPageName" runat="Server">
            <div class="headerPanel">
                <%=WikiUCResource.editWiki_PageName%>
            </div>
            <div class="subHeaderPanel">
                <asp:TextBox ID="txtPageName" MaxLength="250" CssClass="textEdit" runat="Server" Style="width:99%;" />
            </div>
        </asp:PlaceHolder>
        <div id="<%=this.ClientID%>_PrevContainer" style="display: none;">
            <div class="headerPanel">
                <%=WikiUCResource.editWiki_PagePreview%>
            </div>
            <div class="subHeaderPanel">
        ...
        <div class="headerPanel">
            <%=WikiUCResource.editWiki_PageBody%>
        </div>
