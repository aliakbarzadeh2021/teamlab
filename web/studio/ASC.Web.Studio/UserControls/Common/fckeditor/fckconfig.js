...
FCKConfig.Plugins.Add( 'video', 'en,ru' ) ;
FCKConfig.Plugins.Add( 'attach', 'en,ru' ) ;
FCKConfig.Plugins.Add( 'asccut', 'en,ru' ) ;
FCKConfig.Plugins.Add( 'quote', 'en,ru' ) ;
FCKConfig.Plugins.Add( 'ascuser', 'en,ru' ) ;
FCKConfig.Plugins.Add( 'code', 'en,ru' ) ;
...
FCKConfig.ToolbarSets["JJStyle"] = [
	...
	['Link','Unlink'],
	['AscUser', 'Image','Video', 'Table', 'Smiley','AscCut'],
