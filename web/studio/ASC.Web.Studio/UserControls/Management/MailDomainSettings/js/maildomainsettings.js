...
MailDomainSettingsManager = new function() {
    ...
    this.AddTrustedDomain = function() {
        ...
        sb += '<a class="removeDomain" href="javascript:void(0);" onclick="MailDomainSettingsManager.RemoveTrustedDomain(\'' + maxNumb + '\');"><img alt="" align="absmiddle" border="0" src="' + SkinManager.GetImage("trash.png") + '"/></a>';
        sb += '</div>';
    ...
    this.SaveSettings = function() {
        ...
        MailDomainSettingsController.SaveMailDomainSettings(type, domains, function(result) {
