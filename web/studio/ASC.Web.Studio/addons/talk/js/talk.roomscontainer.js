...
window.ASC.TMTalk.roomsContainer = (function ($) {
  ...
  var onRecvInvite = function (roomjid, inviterjid, reason) {
    $('#hdnInvitationRoom').val(roomjid);
    $('#hdnInvitationContact').val(inviterjid);
    $('#lblInviterName').empty().html(ASC.TMTalk.mucManager.getContactName(inviterjid));

    TMTalk.showDialog('recv-invite', ASC.TMTalk.mucManager.getConferenceName(roomjid));
  };
  ...
  $(function () {
    ...
    $('#talkRoomsContainer')
      ...
      .click(function (evt) {
        ...
        if (ASC.TMTalk.dom.hasClass(target, 'button') && ASC.TMTalk.dom.hasClass(target, 'remove-member')) {
          ...
          if (ASC.TMTalk.dom.hasClass(contact, 'contact')) {
            ...
            if (ASC.TMTalk.dom.hasClass(room, 'room')) {
              if (ASC.TMTalk.dom.hasClass(room, 'conference')) {
                ...
                if (jid) {
                  $('#hdnKickJId').val(jid);
                  TMTalk.showDialog('kick-occupant', ASC.TMTalk.mucManager.getContactName(jid));
                }
              } else if (ASC.TMTalk.dom.hasClass(room, 'mailing')) {
                var
                  listId = room.getAttribute('data-roomcid'),
                  jid = contact.getAttribute('data-cid');
                if (listId && jid) {
        ...
        } else if (ASC.TMTalk.dom.hasClass(target, 'button') && ASC.TMTalk.dom.hasClass(target, 'toggle-minimizing')) {
        ...
        } else if (ASC.TMTalk.dom.hasClass(target, 'button') && ASC.TMTalk.dom.hasClass(target, 'close-history')) {
        ...
        } else if (ASC.TMTalk.dom.hasClass(target, 'button') && ASC.TMTalk.dom.hasClass(target, 'search-start')) {
          var room = target.parentNode.parentNode.parentNode;
          if (ASC.TMTalk.dom.hasClass(room, 'room')) {
            var
              nodes = null,
        ...
        } else if (ASC.TMTalk.dom.hasClass(target, 'button') && ASC.TMTalk.dom.hasClass(target, 'search-prev-message')) {
          var room = target.parentNode.parentNode.parentNode;
          if (ASC.TMTalk.dom.hasClass(room, 'room')) {
            var
              node = null,
        ...
        } else if (ASC.TMTalk.dom.hasClass(target, 'button') && ASC.TMTalk.dom.hasClass(target, 'search-next-message')) {
          var room = target.parentNode.parentNode.parentNode;
          if (ASC.TMTalk.dom.hasClass(room, 'room')) {
            var
              node = null,
    ...
    $('#talkDialogsContainer').click(function (evt) {
      ...
      if ($target.hasClass('button') && $target.hasClass('kick-occupant')) {
        var
      ...
      } else if ($target.hasClass('button') && $target.hasClass('remove-room')) {
        var
      ...
      } else if ($target.hasClass('button') && $target.hasClass('accept-invite')) {
        var
        ...
        TMTalk.hideDialog();
      } else if ($target.hasClass('button') && $target.hasClass('decline-invite')) {
        var
          roomjid = ASC.TMTalk.trim($('#hdnInvitationRoom').val()),
          inviterjid = ASC.TMTalk.trim($('#hdnInvitationContact').val());
        if (roomjid) {
