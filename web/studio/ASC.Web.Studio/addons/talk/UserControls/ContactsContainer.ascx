...
<script type="text/javascript">
  ASC.TMTalk.contactsContainer.init();
</script>
  ...
  <div id="talkContactToolbarContainer">
    <div class="unread-messages" title="<%=TalkResource.HintUnreadMessages%>" unselectable="on">
      <div class="button-container" unselectable="on">
        ...
        <div class="button read-new-message" unselectable="on">0</div>
      </div>
    </div>
    <div class="toolbar" unselectable="on">
      <div class="button-container toggle-offlineusers" title="<%=TalkResource.HintOfflineContacts%>" unselectable="on"><div class="button toggle-offlineusers" unselectable="on"></div></div>
      <div class="button-container toggle-group" title="<%=TalkResource.HintGroups%>" unselectable="on"><div class="button toggle-group" unselectable="on"></div></div>
      <div class="button-container toggle-sounds" title="<%=TalkResource.HintSounds%>" unselectable="on"><div class="button toggle-sounds" unselectable="on"></div></div>
      <div class="button-container toggle-notifications disabled" title="<%=TalkResource.HintNotifications%>" unselectable="on"><div class="button toggle-notifications" unselectable="on"></div></div>
      <div class="button-container toggle-filter" title="<%=TalkResource.HintFilter%>" unselectable="on"><div class="button toggle-filter" unselectable="on"></div></div>
    </div>
  ...
  <div id="talkContactsContainer">
    <ul class="contactlist" unselectable="on">
      <li class="contact offline default" unselectable="on">
        ...
        <div class="toolbar" unselectable="on">
          <div class="button send-invite" title="<%=TalkResource.BtnSendInvite%>"></div>
          <div class="button add-to-mailing" title="<%=TalkResource.BtnAddToMailing%>" unselectable="on"></div>
        </div>
      ...
      <li class="group default" unselectable="on">
        ...
        <ul class="contactlist" unselectable="on">
          <li class="contact offline default" unselectable="on">
            <div class="state" unselectable="on"></div>
            <div class="toolbar" unselectable="on">
              <div class="button send-invite" title="<%=TalkResource.BtnSendInvite%>" unselectable="on"></div>
              <div class="button add-to-mailing" title="<%=TalkResource.BtnAddToMailing%>" unselectable="on"></div>
            </div>
            <div class="title" unselectable="on"></div>
          </li>
