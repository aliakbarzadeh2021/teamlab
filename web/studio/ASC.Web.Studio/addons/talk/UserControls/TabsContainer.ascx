  ...
  <ul class="tabs">
    <li class="tab default" unselectable="on">
      ...
      <div class="container" unselectable="on">
        ...
        <div class="button close" unselectable="on"></div>
        <div class="tab-title" unselectable="on"></div>
      </div>
    </li>
  </ul>
  <div class="navigation" unselectable="on">
    <div class="button-container move-to-left" title="<%=TalkResource.HintShowLeftTab%>" unselectable="on"><div class="button move-to-left"></div></div>
    <div class="button-container move-to-right" title="<%=TalkResource.HintShowRightTab%>" unselectable="on"><div class="button move-to-right"></div></div>
  </div>
