...
-- files_filepreview
CREATE TABLE `files_filepreview` (
  `id` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  ...
  `perf` int(10) NOT NULL DEFAULT '0',
  `tenant_id` int(11) NOT NULL,
  PRIMARY KEY (`id`,`version`)
);
-- files_filepreview_stat
CREATE TABLE `files_filepreview_stat` (
  `time` datetime NOT NULL,
  `queued` int(10) NOT NULL DEFAULT '0',
  `converting` int(10) NOT NULL DEFAULT '0',
  `errors` int(10) NOT NULL DEFAULT '0',
  `perf` float NOT NULL DEFAULT '0',
  `converted` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`time`)
);
-- files_filetext
CREATE TABLE `files_filetext` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `files_security` (
  ...
  PRIMARY KEY (`tenant_id`,`entry_id`,`entry_type`,`subject`,`owner`)
);
-- files_tag
