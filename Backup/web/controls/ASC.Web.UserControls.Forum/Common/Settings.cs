...
namespace ASC.Web.UserControls.Forum.Common
{
    public class Settings : IDisposable
    {
        ...
        public ForumUserActivityPublisher ActivityPublisher { get; internal set; } 
        ...
        public ForumPresenterSettings PresenterSettings { get; private set; }
        ...
        public void Dispose()
        {
            ...
            if(this.ActivityPublisher!=null)
                this.ActivityPublisher.Dispose();
        }
