...
namespace ASC.Web.UserControls.Wiki
{
    ...
    public partial class HtmlWikiUtil
    {
        ...
        /*private static string[] SupportedHtmlTags = { 
                                                    "br", "em", "strong", "b", "i", "u", "strike", "h1", "h2", "h3", "h4", "a",
                                                    ...
                                                    "dd", "dl", "dt", "li", "menu", "ol", "ul", "button", "fieldset", "input", "optgroup",
                                                    "option", "select", "textarea", "iframe", "legend", "span", "label"
                                                    };*/
        ...
        {
            //Regex tagsReg = new Regex(@"</.+>");//new Regex(@"</?(.|\n)*?>");
            string result = text.Replace("[", "&#91;").Replace("]", "&#93;");
            result = HttpUtility.HtmlEncode(result);
            return result;// tagsReg.Replace(result, string.Empty);
        }
        ...
        private static string DecriptWikiTags(string text)
        {
            ...
            //HtmlDocument doc = new HtmlDocument();
            //doc.LoadHtml(result);
            return result;//doc.DocumentNode.InnerHtml;
        }
        ...
        {
            return string.Empty;
            //#REDIRECT [[United States#History |  PageDescription]]
        }
        //EndTodo
