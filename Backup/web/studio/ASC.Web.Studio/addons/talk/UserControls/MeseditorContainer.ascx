...
<script type="text/javascript">
  ASC.TMTalk.meseditorContainer.init('talkTextareaContainer', '<%=GetMeseditorStyle()%>');
</script>
  ...
  <div id="talkMeseditorToolbarContainer">
    <div class="toolbar" unselectable="on">
      <div class="button-container emotions" title="<%=TalkResource.HintEmotions%>" unselectable="on">
        <div class="button emotions" unselectable="on"></div>
      ...
      <div class="button-container send-file" id="talkFileUploader" title="<%=TalkResource.HintSendFile%>" unselectable="on"><ascwc:ProgressFileUploader runat="server" ID="TalkFileUploader"></ascwc:ProgressFileUploader></div>
      <asp:PlaceHolder ID="talkHistoryButton" runat="server">
        <div class="button-container history" title="<%=TalkResource.HintHistory%>" unselectable="on"><div class="button history" unselectable="on"></div></div>
      </asp:PlaceHolder>
      <asp:PlaceHolder ID="talkToggleSendButton" runat="server">
        <div class="button-container toggle-sendbutton" title="<%=TalkResource.HintCtrlEnterSender%>" unselectable="on"><div class="button toggle-sendbutton" unselectable="on"></div></div>
      </asp:PlaceHolder>
      <asp:PlaceHolder ID="talkMassendButton" runat="server">
        <div class="button-container create-massend" title="<%=TalkResource.HintCreateMassend%>" unselectable="on"><div class="button create-massend" unselectable="on"></div></div>
      </asp:PlaceHolder>
      <asp:PlaceHolder ID="talkConferenceButton" runat="server">
        <div class="button-container create-conference" title="<%=TalkResource.HintCreateConference%>" unselectable="on"><div class="button create-conference" unselectable="on"></div></div>
      </asp:PlaceHolder>
      <div class="button-container remove-mailing">
        ...
        <div class="button remove-mailing" title="<%=TalkResource.BtnRemoveMailing%>" unselectable="on"></div>
      </div>
      <div class="button-container remove-conference">
        ...
        <div class="button remove-conference" title="<%=TalkResource.BtnRemoveConference%>" unselectable="on"></div>
      </div>
    </div>
    <div id="talkSendMenu">
      <div class="left-side"></div>
      ...
      <div class="button send-message" title="<%=TalkResource.HintSendMessage%>" unselectable="on"></div>
    </div>
  </div>
</div>
