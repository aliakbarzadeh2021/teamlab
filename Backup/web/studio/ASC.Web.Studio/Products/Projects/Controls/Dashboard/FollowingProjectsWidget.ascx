...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FollowingProjectsWidget.ascx.cs"
 Inherits="ASC.Web.Projects.Controls.Dashboard.FollowingProjectsWidget" %>
    ...
    <ItemTemplate>
        ...
        <div class="pm-dashboard-bottomIndent">
            <div class="pm-dashboard-fadeParent">
                ...
                <a class="linkHeaderLightMedium" title="<%# (Container.DataItem as Project).Title%>"
