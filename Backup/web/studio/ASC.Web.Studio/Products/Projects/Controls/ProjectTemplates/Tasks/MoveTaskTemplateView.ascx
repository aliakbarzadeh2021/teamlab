...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MoveTaskTemplateView.ascx.cs"
    Inherits="ASC.Web.Projects.Controls.ProjectTemplates.Tasks.MoveTaskTemplateView" %>
                    ...
                    <asp:Repeater ID="rptMilestoneSelector" runat="server">
                        <ItemTemplate>
                            <div class='<%# Container.ItemIndex%2==0 ? "tintMedium" : "tintLight" %>' style="border-top: 1px solid #D1D1D1; padding: 5px;">
                                ...
                                <label for="milestone_<%# Eval("Id")%>"><%# GetMilestoneTitle((Container.DataItem as TemplateMilestone))%></label>
                            </div>           
                        </ItemTemplate>
                    </asp:Repeater>
