...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="folder">
    <div class="clearFix fileRow folderRow newFolder" name="addRow">
      ...
      <div class="sub-folder move-to">
        ...
        <xsl:if test="not(starts-with(id, 'NEW_FOLDER'))">
      ...
      <div class="sub-info">
        ...
        <div class="fileInfo">
          ...
          <span class="span_space"></span>
          <span>
            <xsl:attribute name="id">content_folder_create_on_<xsl:value-of select="id" /></xsl:attribute>
  ...
  <xsl:template match="file">
    <div class="clearFix fileRow newFile" style="display:none;" name="addRow">
      ...
      <div class="folder-file move-to">
        ...
        <xsl:attribute name="title"><xsl:value-of select="title" /></xsl:attribute>
        <xsl:if test="not(starts-with(id, 'NEW_FILE'))">
